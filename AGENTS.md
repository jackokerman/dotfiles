...
- Keep `HOMEBREW_DOTFILES_ENV=remote` installs serialized in `scripts/brew-sync.sh`; concurrent Linuxbrew downloads and formula jobs have caused intermittent bootstrap failures through shared prefix state.
