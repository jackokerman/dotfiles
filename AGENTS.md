...
- Put generic always-on Codex instruction behavior, including simplicity and anti-overengineering guidance, in `home/.ruler/AGENTS.md`. Keep `home/.codex/AGENTS.md` as the rollback source for `DOTTY_CODEX_RULER=0` until the Ruler pilot is fully landed.
