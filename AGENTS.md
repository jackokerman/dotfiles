...
- Keep shared keyboard modifier behavior, such as generic Karabiner Hyper-key remaps, in this repo. Route app-specific or host-specific Hyper actions to local overrides or later repos in the dotty chain.
