...
# For Bluetooth trackpad (Magic Trackpad)
defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad Clicking -bool true
# Global tap behavior settings
...
# Set keyboard repeat rate and delay for better VIM usage
# Set a short initial key repeat delay (lower number = faster)
defaults write NSGlobalDomain InitialKeyRepeat -int 10
# Set a fast key repeat rate (lower number = faster)
defaults write NSGlobalDomain KeyRepeat -int 2

# Disable press and hold for special characters (prevents accidental character input)
...
# Disable True Tone
sudo defaults write /Library/Preferences/.GlobalPreferences.plist TrueTone -bool false
...
# Disable thumbnail preview after screenshot
