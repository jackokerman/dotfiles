...
cleanup_legacy_gsd_core() {
    local codex_dir="$HOME/.codex"
    local installer="$HOME/.local/bin/gsd-core-install"
    local checkout_installer="$HOME/.local/share/gsd-core/repo/bin/install.js"
...
main() {
    ...
    setup_jackie_plan
    setup_codex
    # TODO: Remove this after the GSD Core cleanup has propagated to managed machines.
    cleanup_legacy_gsd_core
    setup_tmux_agent_bar
}
