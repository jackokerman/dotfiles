...
The reason for this split is simple: dotty may link tracked paths directly into the live home directory. Writing mutable state into repo-backed config paths causes the repo clone to behave like application storage.
