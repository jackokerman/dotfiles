...
- In personal dotfiles and devtool repos, do not add or preserve tests by default. Add tests only for behavior with a real drift history, fragile cross-boundary integration, shell parsing, generated output, or another concrete breakage pattern; otherwise prefer direct verification and simpler code.
