...
_session_status_dir="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
_agent_pane_state_lib="${_session_status_dir}/agent-pane-state.sh"
_session_status_lib="${_session_status_dir}/session-status-lib.sh"
